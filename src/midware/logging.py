...
class LoggingMiddleware(AgentMiddleware):
    ...
    def _log_tool_call(self, tool_name: str, tool_args: Dict[str, Any],
    ...
    def wrap_model_call(
        ...
        try:
            ...
            self._log_error(
                ...
                str(e),
                {
                    "request_content_preview": request_content[:100] + "..." if len(request_content) > 100 else request_content,
                    "execution_time": time.time() - start_time
                }
            )
            raise
