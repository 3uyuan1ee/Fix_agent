...
class LLMError(Exception):
    """LLM基础异常类"""
    def __init__(self, message: str, provider: str = None, error_code: str = None, details: dict = None):
    ...
    def __str__(self):
        ...
        if self.provider and self.error_code:
            return f"{self.message} (provider: {self.provider}, code: {self.error_code})"
        return self.message
