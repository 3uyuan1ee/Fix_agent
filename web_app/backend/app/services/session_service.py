...
class SessionService:
    ...
    def update_session_title(self, session_id: str, title: str) -> Optional[SessionResponse]:
    ...
    def add_message(self, session_id: str, content: str, role: str, metadata: Dict[str, Any] = None) -> Message:
    ...
    def _to_response(self, db_session: DBSession) -> SessionResponse:
        ...
        message_count = self.db.query(Message).filter(
            Message.session_id == db_session.session_id
        ).count()
